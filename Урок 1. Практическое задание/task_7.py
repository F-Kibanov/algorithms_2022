...
def pal_checker(string):
    dc_obj = DequeClass()
    for el in string:
        if el == ' ':                       # Добавил нечувствителность к пробелам
            continue
        dc_obj.add_to_rear(el.lower())      # Добавил нечувствительность к заглавным буквам
    still_equal = True
...
print(pal_checker("Аргентина манит негра"))         # True
print(pal_checker('161'))                           # True
